# tab-overflow-menu-navigation Specification

## Purpose
TBD - created by archiving change redesign-tabs-with-overflow-menu. Update Purpose after archive.
## Requirements
...
- **THEN** system opens a popover showing menu options for `Asiakkaat`, `Kategoriat`, and `Profiili`
