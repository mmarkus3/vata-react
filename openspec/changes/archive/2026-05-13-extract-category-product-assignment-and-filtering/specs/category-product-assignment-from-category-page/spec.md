...
#### Scenario: Filter candidate products
- **WHEN** a user enters a product search term in assignment flow
- **THEN** the candidate list is filtered to matching products
- **AND** clearing the search restores the full candidate list
