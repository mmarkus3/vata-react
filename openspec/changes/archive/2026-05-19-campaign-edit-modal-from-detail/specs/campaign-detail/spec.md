...
### Requirement: Campaign detail supports edit action
The system SHALL provide edit action on campaign detail page.

#### Scenario: Edit action visible
- **WHEN** campaign detail page is loaded successfully
- **THEN** user can open campaign edit modal from detail page
